 ...
 *
 * Contact zhao@bloch.phys.uwm.edu or visit
...
/*
 * $Id: Basic.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
/* timeouts */
FL_EXPORT int fl_add_timeout(long, void (*)(int, void *), void *);
...
#endif /* Basic.h *} */
/*
 * $Id: XBasic.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
#endif /* XBasic.h *} */
/*
 * $Id: bitmap.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 *   Object Class: Bitmap
 */
#ifndef FL_BITMAP_H
...
#endif /* BITMAP_H  } */
/*
 * $Id: box.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_BOX_H
#define FL_BOX_H		/* { */
...
#endif /* !def BOX_H } */
/*
 * $Id: browser.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
#endif /* BROWSER_H } */
/*
 * $Id: button.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
#endif /* Button.h  } */
/*
 * $Id: canvas.h,v 0.88 1997/11/13 05:27:05 zhao Beta $
 *
...
#endif /**** ! FL_CANVAS_H *****}**/
/*
 * $Id: chart.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 * Object Class: Chart
 *
 */
...
#endif /* !def CHART_H } */
/*
 * $Id: choice.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_CHOICE_H
#define FL_CHOICE_H		/* { */
...
#define FL_CHOICE_MAXITEMS	80

/***** Routines *****/

FL_EXPORT FL_OBJECT *fl_create_choice(int, FL_Coord, FL_Coord, FL_Coord, FL_Coord,
				      const char *);

FL_EXPORT FL_OBJECT *fl_add_choice(int, FL_Coord, FL_Coord, FL_Coord, FL_Coord, const char *);
...
#endif /* !def CHOICE_H } */
/*
 * $Id: clipbd.h,v 0.11 1997/07/31 22:54:33 zhao Exp $
 *
...
/*
 * $Id: clock.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_CLOCK_H
#define FL_CLOCK_H		/* { */
...
#endif /* !def CLOCK_H } */
/*
 * $Id: counter.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
...
/*
 * $Id: cursor.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
#endif /* cursor.h   *} */
/*
 * $Id: dial.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 */
#ifndef FL_DIAL_H
#define FL_DIAL_H		/* { */
...
#endif /* !def DIAL_H } */
/*
 * $Id: filesys.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
FL_EXPORT void fl_set_dirlist_sort(int);
...
/*
 * $Id: flps.h,v 0.11 1997/08/21 04:57:08 zhao Exp $
 */
...
enum 
{
  FLPS_AUTO, FLPS_LANDSCAPE, FLPS_PORTRAIT
};
...
typedef struct { FLPS_MEMBERS; } FLPS_CONTROL;
...
/*
 * $Id: free.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 *  Object Class: Free
 */
#ifndef FL_FREE_H
...
#endif /* !def FREE_H } */
/*
 * $Id: goodies.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 */
#ifndef FL_GOODIES_H
#define FL_GOODIES_H		/* { */
...
#endif /* } */
/*
 * $Id: input.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_INPUT_H
#define FL_INPUT_H		/* { */
...
FL_EXPORT FL_OBJECT *fl_create_input(int, FL_Coord, FL_Coord, FL_Coord, FL_Coord,
				     const char *);

FL_EXPORT FL_OBJECT *fl_add_input(int, FL_Coord, FL_Coord, FL_Coord, FL_Coord, const char *);
...
#endif /* Input_H  } */
/*
 * $Id: menu.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_MENU_H
#define FL_MENU_H		/* { */
...
#endif /* MENUBAR } */
/*
 * $Id: popup.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
...
#define FL_MAXPUPI     80	/* max item each pup        */
...
#endif /* Xpopup } */
/*
 * $Id: positioner.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
...
#endif   /* SCROLLBAR */
/*
 * $Id: slider.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 * Object Class: Slider
 *
 */
...
#endif /* } */
/*
 * $Id: tabfolder.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_FOLDER_H
#define FL_FOLDER_H		/* { */
...
#define FL_NORMAL_TABFOLDER    FL_TOP_TABFOLDER

FL_EXPORT FL_OBJECT *fl_create_tabfolder(int, FL_Coord, FL_Coord, FL_Coord,
					 FL_Coord, const char *);

FL_EXPORT FL_OBJECT *fl_add_tabfolder(int, FL_Coord, FL_Coord, FL_Coord, FL_Coord,
				      const char *);
...
/*
 * $Id: timer.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 *  Object Class: Timer
 *
 */
...
#endif /* TIMER_H } */
/*
 * $Id: xyplot.h,v 0.88 1998/02/22 05:35:07 zhao Beta $
 *
 */
#ifndef FL_XYPLOT_H
#define FL_XYPLOT_H		/* { */
...
FL_EXPORT void fl_add_xyplot_overlay(FL_OBJECT *, int, float *, float *, int, FL_COLOR);
FL_EXPORT int fl_add_xyplot_overlay_file(FL_OBJECT *, int, const char *, FL_COLOR);
...
FL_EXPORT void fl_get_xyplot_overlay_data(FL_OBJECT *, int, float *, float *, int *);
